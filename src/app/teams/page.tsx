...
export default function TeamsPage() {
    ...
    // ⚠️ Generate dots CLIENT-SIDE ONLY to avoid SSR hydration mismatch
    // Math.random() at module level produces different values on server vs client
    ...
    return (
        <main className="relative bg-black min-h-screen">
            ...
            >
                ...
                {/* Floating dots — rendered only after hydration */}
                {dots.map((dot) => (
                    <div
                        key={dot.id}
